...
export const featurePresets: Record<FeatureName, FeaturePreset> = {
  ...
  ClickToCopy: { note: 'Click-to-copy UI behavior is planned; baseline table rendering is active.' },
  ...
  RowNumbers: { note: 'Display row number column is planned in display-column slice.' },
